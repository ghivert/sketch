...
-spec optional(fun((dynamic_()) -> {ok, DHL} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        gleam@option:option(DHL)} |
    {error, list(decode_error())}).
optional(Decode) ->
...
-spec any(list(fun((dynamic_()) -> {ok, DLL} | {error, list(decode_error())}))) -> fun((dynamic_()) -> {ok,
        DLL} |
    {error, list(decode_error())}).
any(Decoders) ->
...
) -> fun((dynamic_()) -> {ok, {ok, DGZ} | {error, DHB}} |
    {error, list(decode_error())}).
...
-spec list(fun((dynamic_()) -> {ok, DHG} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        list(DHG)} |
    {error, list(decode_error())}).
list(Decoder_type) ->
    fun(Dynamic) ->
...
-spec map_errors(
    {ok, DFU} | {error, list(decode_error())},
...
-spec optional_field(
    any(),
    fun((dynamic_()) -> {ok, DHZ} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, gleam@option:option(DHZ)} |
    {error, list(decode_error())}).
...
) -> fun((dynamic_()) -> {ok, {DJH, DJJ}} | {error, list(decode_error())}).
...
) -> fun((dynamic_()) -> {ok, {DJM, DJO, DJQ}} | {error, list(decode_error())}).
...
-spec tuple4(
    fun((dynamic_()) -> {ok, DJT} | {error, list(decode_error())}),
...
) -> fun((dynamic_()) -> {ok, {DJT, DJV, DJX, DJZ}} |
    {error, list(decode_error())}).
...
-spec tuple5(
    ...
    fun((dynamic_()) -> {ok, DKE} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DKG} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DKI} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DKK} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {DKC, DKE, DKG, DKI, DKK}} |
    {error, list(decode_error())}).
...
-spec tuple6(
    ...
    fun((dynamic_()) -> {ok, DKR} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DKT} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DKV} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DKX} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {DKN, DKP, DKR, DKT, DKV, DKX}} |
    {error, list(decode_error())}).
...
) -> fun((dynamic_()) -> {ok, gleam@dict:dict(DLA, DLC)} |
    {error, list(decode_error())}).
...
-spec decode6(
    fun((DND, DNE, DNF, DNG, DNH, DNI) -> DNJ),
...
-spec decode7(
    fun((DNR, DNS, DNT, DNU, DNV, DNW, DNX) -> DNY),
...
-spec decode8(
    fun((DOH, DOI, DOJ, DOK, DOL, DOM, DON, DOO) -> DOP),
...
-spec decode9(
    fun((DOZ, DPA, DPB, DPC, DPD, DPE, DPF, DPG, DPH) -> DPI),
