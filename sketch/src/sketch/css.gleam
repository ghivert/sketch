...
import gleam/list
import gleam/string
import sketch/css/font_face.{type FontFace}
import sketch/css/keyframe.{type Keyframe}
...
/// ---
///
/// [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/Class_selectors)
pub fn class(styles: List(Style)) -> Class {
  style.class(styles)
}

pub fn global(name: String, styles: List(Style)) -> Global {
  style.Global(style.named(name, styles))
}
...
/// >
/// > [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/CSS_media_queries/Using_media_queries)
///
/// ```gleam
/// pub fn my_class() {
///   css.class([
...
/// ---
///
/// [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/::file-selector-button)
...
/// ---
///
/// [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/:autofill)
...
/// ---
///
/// [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/:buffering)
...
/// ---
///
/// [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/:muted)
...
/// ---
///
/// [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/:paused)
...
/// ---
///
/// [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/:playing)
...
/// ---
///
/// [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/:seeking)
...
/// ---
///
/// [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/:stalled)
...
/// ---
///
/// [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/:state)
...
/// ---
///
/// [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/:volume-locked)
...
/// ---
///
/// [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/:nth-child)
...
/// ---
///
/// [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/:nth-last-child)
...
/// ---
///
/// [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/:nth-of-type)
...
/// ---
///
/// [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/:nth-last-of-type)
...
/// ---
///
/// [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/Child_combinator)
...
/// ---
///
/// [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/Descendant_combinator)
...
/// ---
///
/// [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/Next-sibling_combinator)
...
/// ---
///
/// [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/Subsequent-sibling_combinator)
...
/// ---
///
/// [MDN Reference](https://developer.mozilla.org/docs/Web/CSS/important)
...
/// The @keyframes CSS [at-rule](https://developer.mozilla.org/docs/Web/CSS/At-rule)
...
pub fn font_face(font_faces: List(FontFace)) -> AtRule {
  ...
  |> string.append("\n", _)
  |> string.append("\n")
  |> style.content_rule("font-face", _)
}
