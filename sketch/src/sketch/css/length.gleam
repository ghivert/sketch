//// `Length` defines a [CSS Unit](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Values_and_Units).
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#px)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#cm)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#mm)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#q)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#in)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#pc)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#pt)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#cap)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#vh)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#vw)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#vmax)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#vmin)
...
/// [containing block](https://developer.mozilla.org/en-US/docs/Web/CSS/Containing_block),
/// in the direction of the root element's [block axis](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_logical_properties_and_values).
///
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#vb)
...
/// Represents the percentage of the size of the initial
/// [containing block](https://developer.mozilla.org/en-US/docs/Web/CSS/Containing_block),
/// in the direction of the root element's [inline axis](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_logical_properties_and_values).
///
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#vi)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#cqh)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#cqw)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#cqmax)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#cqmin)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#cqb)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#cqi)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#em)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#ex)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#rex)
pub fn rex(value: Float) -> Length {
  Rex(value)
}

/// Equal to the used [advance measure](https://developer.mozilla.org/en-US/docs/Glossary/Advance_measure)
/// of the "水" glyph (CJK water ideograph, U+6C34), found in the font used to
/// render it.
///
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#ic)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#ric)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#rem)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#rch)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#rcap)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#lh)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#rlh)
...
/// ---
///
/// [MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/CSS/length#ch)
